...
/* package contracts-haskell-0.1.0.0 */
#ifndef VERSION_contracts_haskell
#define VERSION_contracts_haskell "0.1.0.0"
#endif /* VERSION_contracts_haskell */
#ifndef MIN_VERSION_contracts_haskell
#define MIN_VERSION_contracts_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_contracts_haskell */
...
#define CURRENT_COMPONENT_ID "contracts-haskell-0.1.0.0-84FfExXNrqvLvr2z5Moug7-contracts-haskell"
