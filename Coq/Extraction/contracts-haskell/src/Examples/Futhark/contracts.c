...
static void futrts_cli_entry_main(struct futhark_context *ctx)
{
    ...
    if (perform_warmup) {
        ...
        assert(futhark_main(ctx, &result_4159) == 0);
        assert(futhark_context_sync(ctx) == 0);
        t_end = get_wall_time();
    ...
    write_scalar(stdout, binary_output, &f64, &result_4159);
    printf("\n");
    ;
}
...
#include <errno.h>
#include <assert.h>
static double static_array_realtype_4156[7] = {5000.0, 5400.0, 5200.0, 5900.0,
                                               5100.0, 3100.0, 5210.0};
static double static_array_realtype_4157[7] = {1.0, 0.99, 0.98, 0.96, 0.94, 0.9,
                                               0.85};
struct memblock {
    int *references;
    char *mem;
...
struct futhark_context {
    ...
    struct memblock static_array_4151;
    struct memblock static_array_4152;
} ;
struct futhark_context *futhark_context_new(struct futhark_context_config *cfg)
{
    ...
    ctx->static_array_4151 = (struct memblock) {NULL,
                                                (char *) static_array_realtype_4156,
                                                0};
    ctx->static_array_4152 = (struct memblock) {NULL,
                                                (char *) static_array_realtype_4157,
                                                0};
    return ctx;
}
void futhark_context_free(struct futhark_context *ctx)
...
static struct futrts_double futrts_main(struct futhark_context *ctx)
{
    double scalar_out_4150;
    struct memblock mem_4146;
    
    mem_4146.references = NULL;
    memblock_alloc(ctx, &mem_4146, 56, "mem_4146");
    
    struct memblock static_array_4151 = ctx->static_array_4151;
    
    memmove(mem_4146.mem + 0, static_array_4151.mem + 0, 7 * sizeof(double));
    
    struct memblock mem_4149;
    
    mem_4149.references = NULL;
    memblock_alloc(ctx, &mem_4149, 56, "mem_4149");
    
    struct memblock static_array_4152 = ctx->static_array_4152;
    
    memmove(mem_4149.mem + 0, static_array_4152.mem + 0, 7 * sizeof(double));
    
    char res_4113;
    int32_t res_4114;
    char loop_while_4115;
    int32_t t0_4116;
    
    loop_while_4115 = 1;
    t0_4116 = 0;
    while (loop_while_4115) {
        int32_t res_4117 = t0_4116 + 1;
        char x_4118 = sle32(0, res_4117);
        char y_4119 = slt32(res_4117, 7);
        char assert_arg_4120 = x_4118 && y_4119;
        char bounds_check_4121;
        
        if (!assert_arg_4120) {
            fprintf(stderr, "Assertion failed at %s: %s\n",
                    "contracts.fut:28:1-28:35 -> contracts.fut:28:12-28:35 -> contracts.fut:26:73-26:113 -> contracts.fut:23:38-23:51",
                    "index out of bounds");
            exit(1);
        }
        
        double x_4122 = *(double *) &mem_4146.mem[res_4117 * 8];
        char not_arg_4123 = x_4122 <= 4000.0;
        char cond_4124 = !not_arg_4123;
        char res_4125 = slt32(res_4117, 4);
        char x_4126 = cond_4124 && res_4125;
        char loop_while_tmp_4153 = x_4126;
        int32_t t0_tmp_4154;
        
        t0_tmp_4154 = res_4117;
        loop_while_4115 = loop_while_tmp_4153;
        t0_4116 = t0_tmp_4154;
    }
    res_4113 = loop_while_4115;
    res_4114 = t0_4116;
    
    char x_4127 = sle32(0, res_4114);
    char y_4128 = slt32(res_4114, 7);
    char assert_arg_4129 = x_4127 && y_4128;
    char bounds_check_4130;
    
    if (!assert_arg_4129) {
        fprintf(stderr, "Assertion failed at %s: %s\n",
                "contracts.fut:28:1-28:35 -> contracts.fut:28:12-28:35 -> contracts.fut:26:73-26:113 -> contracts.fut:24:9-24:22",
                "index out of bounds");
        exit(1);
    }
    
    double x_4131 = *(double *) &mem_4146.mem[res_4114 * 8];
    char cond_4132 = x_4131 <= 4000.0;
    double res_4133;
    
    if (cond_4132) {
        res_4133 = 0.0;
    } else {
        char cond_4134 = slt32(res_4114, 0);
        double y_4135;
        
        if (cond_4134) {
            y_4135 = 0.0;
        } else {
            char y_4136 = slt32(res_4114, 508);
            char assert_arg_4137 = x_4127 && y_4136;
            char bounds_check_4138;
            
            if (!assert_arg_4137) {
                fprintf(stderr, "Assertion failed at %s: %s\n",
                        "contracts.fut:28:1-28:35 -> contracts.fut:28:12-28:35 -> contracts.fut:26:73-26:113 -> contracts.fut:24:114-24:124",
                        "index out of bounds");
                exit(1);
            }
            
            char index_concat_cmp_4139 = sle32(7, res_4114);
            double index_concat_branch_4140;
            
            if (index_concat_cmp_4139) {
                index_concat_branch_4140 = 0.8;
            } else {
                double index_concat_4141 = *(double *) &mem_4149.mem[res_4114 *
                                                                     8];
                
                index_concat_branch_4140 = index_concat_4141;
            }
            
            double res_4142 = index_concat_branch_4140;
            
            y_4135 = res_4142;
        }
        
        double res_4143 = 2000.0 * y_4135;
        
        res_4133 = res_4143;
    }
    scalar_out_4150 = res_4133;
    
    struct futrts_double retval_4155;
    
    retval_4155.v0 = scalar_out_4150;
    memblock_unref(ctx, &mem_4146, "mem_4146");
    memblock_unref(ctx, &mem_4149, "mem_4149");
    return retval_4155;
}
int futhark_main(struct futhark_context *ctx, double *out0)
{
    double scalar_out_4150;
    struct futrts_double ret_4158;
    
    ret_4158 = futrts_main(ctx);
    scalar_out_4150 = ret_4158.v0;
    *out0 = scalar_out_4150;
    return 0;
}
