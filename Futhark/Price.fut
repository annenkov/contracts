...
module type PRICE = {
  val price [num_bits][num_models][num_und][num_dates] :
        { num_mc_it: i32,
          dir_vs: [][num_bits]i32,
...
module Price (P : { val payoff : []f32 -> []f32 -> [][]f32 -> f32 }) : PRICE = {
...
let price [num_bits][num_models][num_und][num_dates]
        { num_mc_it: i32,
          dir_vs: [][num_bits]i32,
          md_cs: [num_models][num_und][num_und]f32,
          md_vols: [num_models][num_dates][num_und]f32,
  ...
  let payoffs   = map (\bb_row: [num_models]f32  ->
                         ...
                         in map3 P.payoff md_discts md_detvals bd_row)
                      bb_mat
