-- Generic pricing
-- ==
-- compiled input @ OptionPricing-data/medium0.in
-- output @ OptionPricing-data/medium0.out
--
-- compiled input @ OptionPricing-data/medium1.in
-- output @ OptionPricing-data/medium1.out
